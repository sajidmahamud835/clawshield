...
const MOCK_SKILLS = [
  {
    ...
    status: 'installed',
    icon: Globe,
    desc: 'Enables the agent to search the live internet.',
  },
  {
    id: '2',
    name: 'Postgres SQL',
    status: 'available',
    icon: Database,
    desc: 'Connect to external databases using secure credentials.',
  },
  {
    id: '3',
    name: 'Python Sandbox',
    status: 'installed',
    icon: Code,
    desc: 'Executes generated python code in a temporary docker container.',
  },
];
